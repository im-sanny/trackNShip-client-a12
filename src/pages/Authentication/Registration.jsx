  ...
  return (
    <div>
      <div className="flex justify-center items-center mt-5">
        <div className="flex w-full max-w-sm mx-auto overflow-hidden rounded-lg lg:max-w-4xl">
          <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
            ...
            <div className="flex items-center justify-between mt-4">
              ...
              <Link
                to="/login"
                className="text-xs text-gray-500 uppercase hover:underline hover:text-blue-500"
              >
                or log in
              </Link>
